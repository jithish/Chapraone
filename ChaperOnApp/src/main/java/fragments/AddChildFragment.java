...
/**
 * Created by ceino on 13/10/15.
 */
public class AddChildFragment extends Fragment implements View.OnClickListener,TimePickerDialog.OnTimeSetListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_addchild, container, false);
        return view;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.back_arrow:
                bus.post(new CloseFragment("AddChildFragJustBack"));
                break;
            case R.id.back_burger:
                bus.post(new CloseFragment("AddChildFrag"));
                break;
