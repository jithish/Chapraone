...
public class TestActivity extends FragmentActivity implements OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    public void onDateSet(DatePickerDialog datePickerDialog, int year, int month, int day) {
        Toast.makeText(TestActivity.this, "new date:" + year + "-" + month + "-" + day, Toast.LENGTH_LONG).show();
    }

    @Override
    public void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute) {
//        Toast.makeText(TestActivity.this, "new time:" + hourOfDay + "-" + minute, Toast.LENGTH_LONG).show();
...
//        output.setText(aTime);
        Toast.makeText(TestActivity.this, "new time:" + hours + ":" + minutes+" "+timeSet, Toast.LENGTH_LONG).show();
    }
}
